...
| 文档名称 | 说明 | 链接 |
|----------|------|------|
| 环境安装 | 配置开发环境的详细步骤，包括 Node.js、OpenCode、Home 持久化 | [查看文档](guide/getting-started/installation.md) |
| 项目挂载 | 将 tilelang-agent 挂载到开发目录的步骤和验证方法 | [查看文档](guide/getting-started/project-setup.md) |
| Home 持久化 | 配置 home 目录持久化，避免容器重启丢失配置 | [查看文档](guide/getting-started/home-persistence.md) |

### 开发指南

| 文档名称 | 说明 | 链接 |
|----------|------|------|
| Skills 使用 | 如何在 TileLang 开发中使用自定义 Skills，自动触发和手动调用 | [查看文档](guide/development/skills.md) |
| 测试策略 | TileLang 开发中的测试方法和策略，包括单元测试、集成测试、性能测试 | [查看文档](guide/development/testing.md) |

### 参考文档

| 文档名称 | 说明 | 链接 |
|----------|------|------|
| 脚本参考 | 详细说明各个脚本的功能、配置项、使用方法和故障排除 | [查看文档](guide/reference/scripts.md) |
| Skills 参考 | Skills 的详细功能说明、使用流程、VSCode 配置和最佳实践 | [查看文档](guide/reference/skills-reference.md) |

### 概览文档

| 文档名称 | 说明 | 链接 |
|----------|------|------|
| 安装脚本概览 | 所有脚本的说明和使用示例，包括完整安装流程 | [查看文档](scripts/README.md) |
| Skills 概览 | 可用 Skills 列表、使用示例和完整开发流程示例 | [查看文档](.agents/skills/README.md) |
